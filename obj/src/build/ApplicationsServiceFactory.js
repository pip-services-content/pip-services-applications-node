...
class ApplicationsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
ApplicationsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-applications", "factory", "default", "default", "1.0");
ApplicationsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-applications", "persistence", "memory", "*", "1.0");
ApplicationsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-applications", "persistence", "file", "*", "1.0");
ApplicationsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-applications", "persistence", "mongodb", "*", "1.0");
ApplicationsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-applications", "controller", "default", "*", "1.0");
ApplicationsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-applications", "service", "seneca", "*", "1.0");
ApplicationsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-applications", "service", "http", "*", "1.0");
