...
class ApplicationsCommandSet extends pip_services_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetApplicationsCommand() {
        return new pip_services_commons_node_2.Command("get_applications", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeGetApplicationByIdCommand() {
        return new pip_services_commons_node_2.Command("get_application_by_id", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('application_id', pip_services_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
    ...
    makeCreateApplicationCommand() {
        return new pip_services_commons_node_2.Command("create_application", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateApplicationCommand() {
        return new pip_services_commons_node_2.Command("update_application", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('application', new ApplicationV1Schema_1.ApplicationV1Schema()), (correlationId, args, callback) => {
            let application = args.get("application");
    ...
    makeDeleteApplicationByIdCommand() {
        return new pip_services_commons_node_2.Command("delete_application_by_id", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('application_id', pip_services_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
