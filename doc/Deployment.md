...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-applications-node": "^1.1.*",
        ...
    }
}
```
...
var plugin = new require('pip-services-applications-node').ApplicationsSenecaPlugin;
...
or by using [ApplicationsSenecaClient](https://github.com/pip-services-content/pip-clients-applications-node/doc/NodeClientApiV1.md/#client_seneca)